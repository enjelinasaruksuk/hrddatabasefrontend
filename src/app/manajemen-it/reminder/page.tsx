      ...
      <div className="p-6 font-['Cambria'] text-gray-800">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* End of Contract */}
            <div className="bg-gradient-to-br from-yellow-100 to-white border border-yellow-200 rounded-lg p-5 shadow-md hover:shadow-lg transition">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-white border border-yellow-200 rounded-lg p-5 shadow-md hover:shadow-lg transition">
              ...
              <p>
                <span className="font-semibold">Name:</span> Dwi Pratama
              </p>
              <p>
                <span className="font-semibold">Position:</span> IT Support
              </p>
              <p>
                <span className="font-semibold">End of Contract:</span> 25 days
                left
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-white border border-yellow-200 rounded-lg p-5 shadow-md hover:shadow-lg transition">
              ...
              <p>
                <span className="font-semibold">Name:</span> Sinta Ayu
              </p>
              <p>
                <span className="font-semibold">Certificate:</span> Network+
                Certification
              </p>
              <p>
                <span className="font-semibold">Expired Certificate:</span> 18
                days left
              </p>
            </div>
          </div>
