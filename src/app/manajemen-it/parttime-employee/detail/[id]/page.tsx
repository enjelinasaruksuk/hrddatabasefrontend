        ...
        <aside className="w-64 bg-gradient-to-b from-yellow-300 via-yellow-100 to-white p-5 flex flex-col gap-2 border-r border-gray-200 shadow-sm font-[Cambria]">
          <Link href="/manajemen-it/dashboard">
            <div className={`flex items-center gap-3 p-2 rounded cursor-pointer transition ${
                pathname === "/manajemen-it/dashboard" ? "bg-yellow-100 shadow-sm" : "hover:bg-yellow-50"
              }`}
            >
              <div className="w-8 h-8 flex items-center justify-center text-black text-xl">🏠</div>
              <span className={`text-sm text-black ${
                  pathname === "/manajemen-it/dashboard" ? "font-semibold" : "font-medium"
                }`}
              >
                Dashboard
              </span>
          ...
          <Link href="/manajemen-it/fulltime-employee">
            <div className={`flex items-center gap-3 p-2 rounded cursor-pointer transition ${
                pathname?.startsWith("/manajemen-it/fulltime-employee") ? "bg-yellow-100 shadow-sm" : "hover:bg-yellow-50"
              }`}
            >
              <div className="w-8 h-8 flex items-center justify-center text-black text-xl">📁</div>
              <span className={`text-sm text-black ${
                  pathname?.startsWith("/manajemen-it/fulltime-employee") ? "font-semibold" : "font-medium"
                }`}
              >
                Fulltime Employee
              </span>
          ...
          <Link href="/manajemen-it/parttime-employee">
            <div className={`flex items-center gap-3 p-2 rounded cursor-pointer transition ${
                pathname?.startsWith("/manajemen-it/parttime-employee") ? "bg-yellow-100 shadow-sm" : "hover:bg-yellow-50"
              }`}
            >
              <div className="w-8 h-8 flex items-center justify-center text-black text-xl">📁</div>
              <span className={`text-sm text-black ${
                  pathname?.startsWith("/manajemen-it/parttime-employee") ? "font-semibold" : "font-medium"
                }`}
              >
                Parttime Employee
              </span>
