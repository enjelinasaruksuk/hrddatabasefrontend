...
export default function ManajemenITParttimeEmployeePage() {
  ...
  const fetchEmployees = async () => {
    try {
      setLoading(true);
      const response = await fetch("http://localhost:5000/api/employees/type/parttime");
      ...
      console.log("Parttime employees (Manajemen IT):", data);
      setEmployees(data);
                    ...
                    <tr key={employee.NIK} className="hover:bg-gray-50 transition">
                      ...
                      <td className="border border-gray-300 px-4 py-2 text-center">
                        <div className="flex justify-center gap-2">
                          {/* Tombol View Detail */}
                          <Link href={`/manajemen-it/parttime-employee/detail/${employee.NIK}`}>
                          ...
                          {/* Tombol Documents */}
                          <Link href={`/manajemen-it/parttime-employee/document/${employee.NIK}`}>
